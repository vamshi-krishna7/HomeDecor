          ...
          <Col xs={12}>
            ...
            {cartItems.length === 0 ? (
              <h5 className="text-center">
                Your Shopping Cart is Empty <Link to="/">Start Shoppping</Link>
              </h5>
            ) : (
              <Fragment>
                <Card>
                  <ListGroup variant="flush">
                    <ListGroupItem>
                      ...
                      <ListGroupItem>
                            <Button vaiant="success" block onClick={onCheckoutHandler}>Proceed To Checkout</Button>
                      </ListGroupItem>
                    </ListGroupItem>
                  </ListGroup>
                </Card>
                    ...
                    <ListGroupItem key={item._id}>
                      <Row>
                        <Col
                          ...
                          sm={4}
                          md={2}
                          className="my-auto list-group-cart-item"
                        >
                        ...
                        <Col xs={3} sm={2} md={3} className="my-auto">
                          <FormControl
                            as="select"
                            className="form-control-cart-item"
                            value={item.qty}
                            onChange={(e) =>
                              dispatch(
                                addToCart(
